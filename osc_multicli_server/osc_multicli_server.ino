 ...
 * Fade function
 */
uint8_t fade(int inc, float rate, float offset) {
...
//void setR(String & res, uint8_t value) {
//  char str[4];
//  itoa(value, str, 10);
//
//  if( value == 0 ) {
...
//    res.setCharAt(0, '0');
//    res.setCharAt(1, '0');
//    res.setCharAt(2, str[0]);
//  } else if ( value < 100 ) {
//    res.setCharAt(0, '0');
//    res.setCharAt(1, str[0]);
//    res.setCharAt(2, str[1]);
//  } else {
//    res.setCharAt(0, str[0]);
//    res.setCharAt(1, str[1]);
//    res.setCharAt(2, str[2]);
//  }
//}
...
//void setB(String & res, uint8_t value) {
//  char str[4];
//  itoa(value, str, 10);
//
//  if( value == 0 ) {
...
//    res.setCharAt(3, '0');
//    res.setCharAt(4, '0');
//    res.setCharAt(5, str[0]);
//  } else if ( value < 100 ) {
//    res.setCharAt(3, '0');
//    res.setCharAt(4, str[0]);
//    res.setCharAt(5, str[1]);
//  } else {
//    res.setCharAt(3, str[0]);
//    res.setCharAt(4, str[1]);
//    res.setCharAt(5, str[2]);
//  }
//}
...
//void setG(String & res, uint8_t value) {
//  char str[4];
//  itoa(value, str, 10);
//
//  if( value == 0 ) {
...
//    res.setCharAt(6, '0');
//    res.setCharAt(7, '0');
//    res.setCharAt(8, str[0]);
//  } else if ( value < 100 ) {
//    res.setCharAt(6, '0');
//    res.setCharAt(7, str[0]);
//    res.setCharAt(8, str[1]);
//  } else {
//    res.setCharAt(6, str[0]);
//    res.setCharAt(7, str[1]);
//    res.setCharAt(8, str[2]);
//  }
//}
...
//void setRPM(String & res, int value) {
//  char str[4];
//  itoa(value, str, 10);
//
//  if( value == 0 ) {
...
//    res.setCharAt(9, '0');
//    res.setCharAt(10, '0');
//    res.setCharAt(11, str[0]);
//  } else if ( value < 100 ) {
//    res.setCharAt(9, '0');
//    res.setCharAt(10, str[0]);
//    res.setCharAt(11, str[1]);
//  } else {
//    res.setCharAt(9, str[0]);
//    res.setCharAt(10, str[1]);
//    res.setCharAt(11, str[2]);
//  }
//}

//void setDir(String & res, int value ) {
//  char d = '0' + value;
//  res.setCharAt(12, d);
//}
